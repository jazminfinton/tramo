...
-- CreateEnum
CREATE TYPE "ProjectRole" AS ENUM ('TRACKER', 'VIEWER');

-- CreateEnum
CREATE TYPE "EntrySource" AS ENUM ('TIMER', 'MANUAL');
...
CREATE TABLE "TimeEntry" (
    ...
    "source" "EntrySource" NOT NULL DEFAULT 'TIMER',
...
-- An entry must end after it starts. Prisma does not model CHECK constraints,
-- so this guarantee lives only in this migration.
ALTER TABLE "TimeEntry" ADD CONSTRAINT "TimeEntry_ends_after_start" CHECK ("endedAt" IS NULL OR "endedAt" > "startedAt");
